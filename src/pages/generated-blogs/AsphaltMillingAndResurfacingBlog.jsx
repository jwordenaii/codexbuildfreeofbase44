...
export default function AsphaltMillingAndResurfacingBlog() {
  const jsonLd = premiumBlogPostingSchema({
    slug: 'info/asphalt-milling-and-resurfacing',
    headline: 'Ultimate Guide to Asphalt Milling And Resurfacing',
    description:
      'Learn everything you need to know about asphalt milling and resurfacing for your commercial properties. Expert insights from J. Worden & Sons.',
  ...
  return (
    <div className="min-h-screen bg-background font-body">
      <SEO
        title={'Ultimate Guide to Asphalt Milling And Resurfacing - J. Worden & Sons'}
        description={'Learn everything you need to know about asphalt milling and resurfacing for your commercial properties. Expert insights from J. Worden & Sons.'}
        canonicalPath={'/blog/info/asphalt-milling-and-resurfacing'}
        jsonLd={jsonLd}
      />
      <Navbar />
      ...
      <article className="pt-32 pb-16 md:pb-20 max-w-4xl mx-auto px-6 lg:px-8">
        <header className="mb-12 border-b border-border pb-10">
          ...
          <h1 className="font-display font-black text-foreground text-4xl md:text-5xl uppercase tracking-tight leading-[0.95] mb-6">
            Ultimate Guide to Asphalt Milling And Resurfacing
          </h1>
        ...
        <div className="prose prose-invert max-w-none text-muted-foreground leading-relaxed space-y-6">
          <p>
            When it comes to <strong>asphalt milling and resurfacing</strong>, understanding the foundational 
          ...
          <h2 className="font-display text-2xl text-foreground uppercase tracking-wide mt-10 mb-4 font-black">
            The Importance of asphalt milling and resurfacing
          </h2>
          <p>
          ...
          <p>
            ...
            By addressing asphalt milling and resurfacing correctly the first time, our clients consistently avoid 
