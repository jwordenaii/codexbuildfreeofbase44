 ...
 * The backend platform capabilities (IoT, GenAI, safety, workforce AI) are
...
const PUBLIC_TOOLS = [
  {
    ...
    desc: 'Take a photo of your driveway on your phone and get an instant AI report: what damage is visible, what prep work is needed, and what service we recommend — before you even call us.',
  ...
  },
  {
    ...
    desc: 'Sketch your driveway outline with your finger or enter simple dimensions. Get an instant square footage calculation and ballpark cost range so you know what to expect.',
    badge: '100% Free · No Login',
...
/* ── Backend platform capabilities (briefly shown) ──────────────────────── */
const PLATFORM_CAPS = [
  {
    icon: '🤖',
    title: 'Generative AI',
    desc: 'Layout optimization and 4D construction sequencing for every project.',
  },
  {
    icon: '🛰️',
    title: 'IoT Integration',
    desc: 'Live fleet telemetry from drones, wearables, mixers, and field sensors.',
  },
  {
    icon: '🦺',
    title: 'AI Safety Monitoring',
    desc: 'Real-time risk signals, sensor triage, and automated incident logging.',
  },
  {
    icon: '👷',
    title: 'Workforce Optimization',
    desc: 'Predictive staffing, cert expiry tracking, and skills-based crew matching.',
  },
  {
    icon: '🧠',
    title: 'Smart Advisory Systems',
    desc: 'Regulatory guidance, market intelligence, and data-driven bid analysis.',
  },
  {
    icon: '📊',
    title: 'Predictive Maintenance',
    desc: 'ML models trained on fleet data predict failures before they happen.',
  },
]
...
export default function JWordenAI() {
  ...
  return (
    <>
      {/* ── Hero ──────────────────────────────────────────────────────── */}
      <section className="relative bg-brand-navy text-white overflow-hidden pt-24 pb-16">
        <div
          aria-hidden="true"
          className="absolute inset-0 pointer-events-none"
          style={{
            background:
              'radial-gradient(ellipse 70% 50% at 65% 40%, rgba(245,166,35,0.12) 0%, transparent 70%)',
          }}
        />
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div {...fadeUp(0)} className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-white/70 text-lg leading-relaxed mb-10 max-w-2xl mx-auto">
              ...
              free for any homeowner or property manager — no login, no obligation. Just snap a
              photo or sketch your driveway and let the AI do the work.
            </p>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {PUBLIC_TOOLS.map((tool, i) => (
              ...
              >
                {/* Color header */}
                <div className={`${tool.color} px-7 pt-8 pb-10 relative overflow-hidden`}>
                  <div
                    aria-hidden="true"
                    className="absolute -bottom-6 -right-6 w-32 h-32 rounded-full bg-white/10"
                  />
                  <span className="text-5xl">{tool.icon}</span>
                  <h3 className={`font-display font-black text-2xl mt-3 mb-1 ${tool.textColor}`}>
                    {tool.title}
                  </h3>
                  <span className="inline-block bg-white/20 backdrop-blur-sm text-xs font-bold px-3 py-1 rounded-full mt-1">
                    <span className={tool.textColor}>{tool.badge}</span>
                  </span>
                </div>
                ...
                <div className="bg-white p-7 flex flex-col gap-4">
                  ...
                  <Link
                    to={tool.ctaHref}
                    state={tool.ctaHash ? { defaultTab: tool.ctaHash } : undefined}
                    className="btn-primary text-sm text-center py-3 px-6 mt-auto"
                  >
                    {tool.cta} →
                  </Link>
                </div>
              ...
              {[
                {
                  ...
                  icon: '📸',
                  title: 'Take a Photo',
                  desc: 'Snap a clear photo of your driveway from ground level or looking down. Your phone camera is perfect.',
                },
                {
                  step: '2',
                  icon: '🤖',
                  title: 'AI Analyzes It',
                  desc: 'JWORDENAI™ reads the image — identifying crack types, surface wear, drainage issues, and more in seconds.',
                },
                {
                  step: '3',
                  icon: '📋',
                  title: 'Get Your Report',
                  desc: 'You receive a plain-English report: condition score, issues found, prep work needed, and recommended service.',
                },
              ].map((s) => (
                <div key={s.step} className="text-center">
                  <div className="w-10 h-10 rounded-full bg-brand-amber text-brand-navy font-black text-lg flex items-center justify-center mx-auto mb-3">
                    {s.step}
                  </div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div {...fadeUp()} className="text-center mb-12">
            ...
            <p className="text-white/60 mt-3 max-w-xl mx-auto">
              Beyond the public tools, JWORDENAI™ powers our entire operation — from the job
              site to the office. These capabilities are available to our team through the
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {PLATFORM_CAPS.map((cap, i) => (
              ...
              >
                ...
                <h3 className="font-display font-bold text-white text-base mt-3 mb-1">
                  {cap.title}
                </h3>
      ...
      <section className="py-16 bg-brand-amber text-center">
        <div className="max-w-2xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Link
              to="/jwordenai/scan"
              className="bg-brand-navy text-white font-black px-8 py-4 rounded-xl hover:bg-brand-navy/90 transition-colors inline-block"
            >
              Scan My Driveway Free
            </Link>
            <Link
              to="/quote"
              className="border-2 border-brand-navy text-brand-navy font-bold px-8 py-4 rounded-xl hover:bg-brand-navy/10 transition-colors inline-block"
            >
