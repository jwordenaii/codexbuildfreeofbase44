...
const SOURCES = [
  ...
  },
  {
    ...
    name: 'Google Search Central Blog (HTML fallback)',
    url: 'https://developers.google.com/search/blog',
    mode: 'html-links',
    linkPattern: /^https:\/\/developers\.google\.com\/search\/blog\/\d{4}\/\d{2}\/[a-z0-9-]+(?:\?hl=en)?$/i,
    maxItems: 80,
  },
  {
  ...
  {
    id: 'deepmind-blog',
    name: 'Google DeepMind Blog (HTML fallback)',
    url: 'https://deepmind.google/discover/blog/',
    mode: 'html-links',
    linkPattern: /^https:\/\/deepmind\.google\/discover\/blog\/[a-z0-9-]+\/?$/i,
    maxItems: 80,
  },
  {
  ...
  },
  {
    ...
    name: 'GitHub Copilot Changelog (HTML fallback)',
    url: 'https://github.blog/changelog/label/copilot/',
    mode: 'html-links',
    linkPattern: /^https:\/\/github\.blog\/changelog\/\d{4}-\d{2}-\d{2}-[a-z0-9-]+\/?$/i,
    maxItems: 80,
  },
  {
    id: 'vercel-changelog',
