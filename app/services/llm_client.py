...
_ROUTES: dict[str, list[tuple[str, str]]] = {
    ...
    "review_reply":    [("anthropic", "claude-opus-5"),       ("anthropic", "claude-sonnet-5"),   ("openai", "gpt-4o")],
...
#
# There were briefly two copies of this tuple after a branch merge and the
# shorter one won by being defined later, which quietly dropped claude-opus-4-8
# and made every call to it a 400. One definition only.
