...
_RATES: dict[str, dict[str, tuple[float, float]]] = {
    ...
    # ── Roofing (All Types) ──────────────────────────────────────────────────
    "roofing_asphalt":      {"residential": (4.50, 7.50),    "commercial": (4.00, 7.00)},
    "roofing_metal":        {"residential": (9.00, 15.00),   "commercial": (8.50, 14.00)},
    "roofing_flat_tpo":     {"residential": (6.50, 11.00),   "commercial": (6.00, 10.00)},
    "roofing_tile_slate":   {"residential": (12.00, 25.00),  "commercial": (15.00, 30.00)},
}
